...
My research with Theocharis Grigoriadis on the spillovers to the CEE region was recently published in [Comparative Economic Studies](https://doi.org/10.1057/s41294-020-00114-3). 
...
![input_data](./README_figs/input_data_plots.png)
...
![MENA_model_1](./README_figs/MENA_model_1.png)

![MENA_model_2](./README_figs/MENA_model_2.png)
...
![CEE_Model](./README_figs/CEE_model.png)
<!--
